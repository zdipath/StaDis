...
class Generic_WSI_Classification_Dataset(Dataset):
	...
	def get_split_from_df(self, all_splits, split_key='train'):
		...
		if len(split) > 0:
			...
			split = Generic_Split(df_slice, data_dir=self.data_dir, num_classes=self.num_classes,data_format = self.data_format)
		else:
			split = None
	...
	def return_splits(self, from_id=True, csv_path=None):
		...
		if from_id:
			if len(self.train_ids) > 0:
				...
				train_split = Generic_Split(train_data, data_dir=self.data_dir, num_classes=self.num_classes,data_format = self.data_format)
			...
			if len(self.val_ids) > 0:
				...
				val_split = Generic_Split(val_data, data_dir=self.data_dir, num_classes=self.num_classes,data_format = self.data_format)
			...
			if len(self.test_ids) > 0:
				...
				test_split = Generic_Split(test_data, data_dir=self.data_dir, num_classes=self.num_classes,data_format = self.data_format)
