...
class TransMIL(nn.Module):
    def __init__(self, embed_dim=1024, n_classes=2, dropout=False, size_arg = "small"):
        super(TransMIL, self).__init__()
        dim_size = 512
        self.pos_layer = PPEG(dim=dim_size)
        self._fc1 = nn.Sequential(nn.Linear(embed_dim, dim_size), nn.ReLU())
...
#         h = self.layer2_attn(h, mask)
        ...
        return logits, Y_prob, Y_hat, A_fea, attn_matrix
