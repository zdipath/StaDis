...
parser.add_argument('--model_type', type=str, 
                    ...
                    default='clam_ensemble', help='type of model (default: clam_sb, clam w/ single attention branch)')
parser.add_argument('--task', type=str,default='task_1_tumor_vs_normal', choices=['task_1_tumor_vs_normal',  'task_2_tumor_subtyping'])

parser.add_argument('--gpu', type=int,default=3, choices=[0,1,2,3,4,5])
...
if args.task == 'task_1_tumor_vs_normal':
    ...
    if args.model_name == 'resnet50':
        args.data_root_dir = '/data/clam_format_feature_resnet50/'
    dataset = Generic_MIL_Dataset(csv_path = args.csv_path,
                            data_dir= os.path.join(args.data_root_dir, args.experiment_mask),
                            shuffle = False, 
                            seed = args.seed, 
